...
- Создать папку со скриптом формирования небольшого Json(в тематику крипты), затем скрипт (отдельный) по чтению
файла (пусть он будет со вложенной структурой) и загрузкой его в ХД